    ...
    <>
      <footer id="contact" className="w-full min-h-[60vh] flex flex-col justify-between px-6 py-20 z-10 relative border-t border-white/10 bg-[#0a0a0a]">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
           <div>
              <p className="text-sm text-gray-500 font-mono mb-2 min-h-[4vh]">OPEN FOR OPPORTUNITIES</p>
           ...
           <div className="flex flex-col gap-4 text-right">
              <a href="mailto:yangml6666@163.com" className="text-xl md:text-3xl text-white hover:text-red-500 transition-colors border-b border-white/20 pb-2 font-mono">
                yangml6666@163.com
              </a>
        ...
        >
          ...
          >
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-2">杨明亮</h3>
              <p className="text-gray-500 mb-6">河北 沧州</p>
              <img
